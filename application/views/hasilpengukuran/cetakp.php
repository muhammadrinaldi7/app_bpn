          ...
          <div class="card">
            ...
            <h5 class="card-title">Cetak <?= $title ?></h5>
              ...
              <div class="tab-content pt-2" id="myTabContent">
                ...
                <div class="col mb-2">
                <form target="_blank" action="<?= base_url('hasilpengukuran/hasilpengukuran/cetakhasilpengukuran') ?>" method="post">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  <a href="<?= base_url('hasilpengukuran/hasilpengukuran/cetakhasilpengukuran1') ?>" target="_blank" class="button btn btn-danger"><i class="bi bi-file-earmark-pdf-fill"></i>Cetak Laporan</a>
                </div>

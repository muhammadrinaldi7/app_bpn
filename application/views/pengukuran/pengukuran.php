      ...
      <div class="card" >
        <div class="card-body">
          ...
          <div class="float-end mb-4">
			    <a href="<?= base_url('pengukuran/pengukuran/tambahData');?>" class="btn btn-primary"><i class="bi bi-plus-circle"></i></i>&nbsp;&nbsp;Tambah</a>			
			    </div>
          <thead>
            <tr>
                <th>No</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $p->status ?></td>          
              <td>
              <a href="<?php echo base_url('pengukuran/pengukuran/updateData/'.$p->kode_ukur);?>" class="btn btn-sm btn-primary"><i class="bi bi-pencil-square"></i></a>
              <a href="<?php echo base_url('pengukuran/pengukuran/cetakPenugasan/'.$p->id_pengukuran);?>" target="_blank" class="btn btn-sm btn-success"><i class="bi bi-printer"></i></a>
              <a onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini ?')" href="<?php echo base_url('pengukuran/pengukuran/deleteData/'.$p->kode_ukur);?>" class="btn btn-sm btn-danger"><i class="bi bi-trash"></i></a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>

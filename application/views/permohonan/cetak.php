    ...
    <div class="col-lg-6">
      <div class="card" >
        <div class="card-body">
          ...
          <div class="text-xl font-weight-bold text-danger text-uppercase mb-1">Cetak Permohonan Hari Ini</div> 
			<div class="col mb-2 mt-2">
			<form target="_blank" action="<?= base_url('permohonan/permohonan/print') ?>" method="post">
            <input type="hidden" readonly name="tgl1" value="<?php echo date('Y-m-d'); ?>" class="form-control mt-2" required autocomplete="off" /> 
			</div>
			<button type="submit" class="mt-2 d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" target="_blank" value="Filter"> 
          ...
          <div class="card">
            ...
            <h5 class="card-title">Cetak <?= $title ?></h5>
              ...
              <div class="tab-content pt-2" id="myTabContent">
                ...
                <div class="col mb-2">
                  <form target="_blank" action="<?= base_url('permohonan/permohonan/print1') ?>" method="post">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  <a href="<?= base_url('permohonan/permohonan/print2') ?>" target="_blank" class="button btn btn-danger"><i class="bi bi-file-earmark-pdf-fill"></i>Cetak Laporan</a>
                </div>

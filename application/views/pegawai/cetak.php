...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      <div class="card" >
        <div class="card-body">
          <h5 class="card-title">Laporan History Kinerja Pengukuran</h5>          
          <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Per Pegawai</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content pt-2" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
                ...
                <div class="col mb-2">
            <form target="_blank" action="<?= base_url('pegawai/pegawai/printhistory') ?>" method="post">
            ...
            <div class="col mb-2">
                ...
                <select class="form-control select" name="nama_pegawai">
            ...
            <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" target="_blank" value="Filter"> 
              ...
              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <br>
                  <a href="<?= base_url('pegawai/Pegawai/printhistory1') ?>" target="_blank" class="button btn btn-danger"><i class="bi bi-file-earmark-pdf-fill"></i>Cetak Laporan</a>
                </div>
            </div>
        </div>
      </div>

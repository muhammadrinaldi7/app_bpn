    ...
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="post" class="needs-validation" novalidate action="<?php echo base_url('pegawai/Pegawai/updateDataAksi');?>">
                <div class="row mb-2">
                ...
                <div class="col-sm-12">
                  ...
                  <input type="text" name="nama_pegawai" class="form-control" value="<?= $p->nama_pegawai ?>" required id="validationCustom02" placeholder="Masukkan Nama Pegawai">
                ...
                <div class="col-sm-12">
                  ...
                  <select name="divisi" class="form-control"  required id="validationCustom06">
                    <option value="<?= $p->divisi ?>" disabled selected><?= $p->divisi ?></option>

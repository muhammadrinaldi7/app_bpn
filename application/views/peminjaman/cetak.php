    ...
    <div class="col-lg-4">
      <div class="card" >
        <div class="card-body">
          ...
          <div class="text-xl font-weight-bold text-danger text-uppercase mb-1">Cetak Peminjaman alat Hari ini</div> 
			<div class="col mb-2">
				<form target="_blank" action="<?= base_url('peminjaman/peminjaman/cetak_peminjaman') ?>" method="post">
          ...
          <div class="card">
            ...
            <h5 class="card-title">Cetak <?= $title ?></h5>
              ...
              <div class="tab-content pt-2" id="myTabContent">
                ...
                <div class="col mb-2">
                  <form target="_blank" action="<?= base_url('peminjaman/peminjaman/cetak_peminjaman1') ?>" method="post">
